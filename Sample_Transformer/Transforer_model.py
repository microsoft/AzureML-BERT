...
sentences = [
    ...
    ['我 想要 一瓶 cola P', 'S i want a coke .', 'i want a coke . E']
]


# Padding Should be Zero
src_vocab = {'P': 0, '我': 1, '想要': 2, '一瓶': 3, '啤酒': 4, 'cola': 5}
...
def get_attn_pad_mask(seq_q, seq_k):
    ...
    return pad_attn_mask.expand(batch_size, len_q, len_k)  # [batch_size, len_q, len_k] 构成立方体(batch_size个这样的矩阵)
...
# Pytorch中的Linear只会对最后一维操作每个位置用同一个全连接网络
